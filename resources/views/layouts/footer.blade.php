                ...
                <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                    <div class="kt-footer__copyright">
                        {{ date('Y') }} &nbsp;&copy;&nbsp;<a href="http://keenthemes.com/metronic" target="_blank" class="kt-link">ADMIN</a>
                    </div>
...
<!--begin:: Global Mandatory Vendors -->
    ...
    <script src="{{ getMediaUrl('admin/assets/demo/demo12/base/scripts.bundle.js')}}" type="text/javascript"></script>
